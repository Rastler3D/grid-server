...
impl EndpointConfigBuilder {
    ...
    pub fn arch(mut self, platform: Platform) -> Self{
    ...
    pub fn build(self) -> Result<(quinn::ClientConfig, quinn::ServerConfig), ConfigError> {
        ...
        let (certificate_chain, private_key) = certificate_provider
            .generate_client_certificate(self.name.clone(), self.platform)?;
        ...
        transport_config.max_idle_timeout(Some(VarInt::from_u32(3000).into()));
